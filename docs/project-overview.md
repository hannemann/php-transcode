...
- **Framework**: Vanilla JavaScript with custom web components
- **Key Libraries**:
  - `hls.js` - HLS video playback
  - `media-chrome` - Media player UI
  - `slim.js` - Component framework
...
### Frontend Components
- `Transcoder` - Main application shell
- `TranscodeConfigurator` - Video processing configuration UI
- `FilePicker` - File browser component
- Various dialog components for specific operations
...
- PostCSS for styling
- Custom web components build system
