...
class TextViewer extends HTMLElement {
    connectedCallback() {
        ...
        document.addEventListener(
            "show-textcontent",
            this.showTextContent.bind(this),
        );
    ...
    show() {
        ...
        document.dispatchEvent(
            new CustomEvent("textviewer-show", { detail: true }),
        );
    ...
    showTextContent(e) {
        ...
        this.shadowRoot.querySelector("pre").textContent = e.detail.content;
        this.classList.add("active");
        document.dispatchEvent(
            new CustomEvent("textviewer-show", { detail: true }),
        );
    ...
    hide() {
        ...
        document.dispatchEvent(
            new CustomEvent("textviewer-show", { detail: false }),
        );
    }
