...
class Buttons extends HTMLElement {
    connectedCallback() {
        ...
        this.btnCheckbox = this.shadowRoot.querySelector(
            'button[data-type="checkbox"]',
        );
        this.btnConfig = this.shadowRoot.querySelector(
            'button[data-type="config"]',
        );
    ...
    configure() {
        document.dispatchEvent(
            new CustomEvent("stream-configure", {
                detail: {
                    origin: this,
                    item: this.item,
                },
    ...
    <main>
        <button data-type="checkbox" class="icon-stack">
            ...
            <span
                ...
                data-icon="mdi-checkbox-blank-outline"
            ></span>
            <span
                class="iconify hover"
                data-icon="mdi-checkbox-blank-outline"
