...
class StreamConfig extends HTMLElement {
    ...
    constructor() {
        super();
        this.videoCodecs = Object.values(VIDEO_CODECS).sort(
            (a, b) => a.v > b.v,
        );
        this.audioCodecs = Object.values(AUDIO_CODECS).sort(
            (a, b) => a.v > b.v,
        );
    ...
    connectedCallback() {
        ...
        const codecTemplate = importNode.querySelector(
        ...
        const channelTemplate = importNode.querySelector(
        ...
        const aspectTemplate = importNode.querySelector(
    ...
    hide() {
        ...
        document.dispatchEvent(
            new CustomEvent("stream-config", { detail: { item: this.item } }),
        );
    ...
    initSettings() {
        ...
        this.codecs = this[`${this.item.codec_type}Codecs`].sort(
            (a, b) => a.id > b.id,
        );
        this.codec =
            typeof codec !== "undefined"
                ? codec
                : this.codecs.find((c) => c.default).v;
        this.qp =
            typeof qp !== "undefined"
                ? qp
                : this.codecs.find((c) => c.default).qp;
        this.channels =
            typeof channels !== "undefined"
                ? channels
                : this.codecs.find((c) => c.default).channels;
    ...
    handleCodecChange(e) {
        ...
        if (this.item.codec_type === "audio") {
            this.channels = this.codecs.find(
                (c) => c.v === this.codec,
            ).channels;
        }
        if (this.item.codec_type === "video") {
