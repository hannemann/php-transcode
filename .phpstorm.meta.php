...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'broadcasting.connections.reverb.key' => 'integer',
            'broadcasting.connections.reverb.secret' => 'integer',
            'broadcasting.connections.reverb.app_id' => 'integer',
            ...
            'broadcasting.connections.pusher.key' => 'integer',
            'broadcasting.connections.pusher.secret' => 'integer',
            'broadcasting.connections.pusher.app_id' => 'integer',
            ...
            'filesystems.disks.recordings.permissions.file.private' => 'integer',
            'filesystems.disks.recordings.permissions.file.public' => 'integer',
            'filesystems.disks.recordings.permissions.dir.private' => 'integer',
            'filesystems.disks.recordings.permissions.dir.public' => 'integer',
            ...
            'laravel-ffmpeg.enable_logging' => 'boolean',
            'laravel-ffmpeg.set_command_and_error_output_on_exception' => 'boolean',
            ...
            'process.binaries.ps' => 'string',
            'process.binaries.kill' => 'string',
            ...
            'queue.connections.ffmpeg.driver' => 'string',
            'queue.connections.ffmpeg.table' => 'string',
            'queue.connections.ffmpeg.queue' => 'string',
            'queue.connections.ffmpeg.retry_after' => 'integer',
            'queue.connections.ffmpeg.after_commit' => 'boolean',
            'queue.connections.player.driver' => 'string',
            'queue.connections.player.table' => 'string',
            'queue.connections.player.queue' => 'string',
            'queue.connections.player.retry_after' => 'integer',
            'queue.connections.player.after_commit' => 'boolean',
            ...
            'reverb.apps.apps.0.key' => 'integer',
            'reverb.apps.apps.0.secret' => 'integer',
            'reverb.apps.apps.0.app_id' => 'integer',
            ...
            'transcode.vaapiDevice' => 'string',
            'transcode.videoCodecs' => 'object',
            'transcode.audioCodecs' => 'object',
            'transcode.subtitleCodecs' => 'object',
            'transcode.preferredLanguages' => 'array',
            'transcode.preferredAudioCodecs' => 'object',
            'view.paths' => 'array',
...
'broadcasting.connections.pusher.app_id','broadcasting.connections.pusher.options.cluster','broadcasting.connections.pusher.options.encrypted','broadcasting.connections.pusher.options.host','broadcasting.connections.pusher.options.port',
'broadcasting.connections.pusher.options.scheme','broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver',
...
'filesystems.disks.s3.bucket','filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.recordings.driver',
'filesystems.disks.recordings.root','filesystems.disks.recordings.throw','filesystems.disks.recordings.permissions.file.private','filesystems.disks.recordings.permissions.file.public','filesystems.disks.recordings.permissions.dir.private',
'filesystems.disks.recordings.permissions.dir.public','filesystems.links./var/www/html/public/storage','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory',
'hashing.argon.threads','hashing.argon.time','hashing.rehash_on_login','laravel-ffmpeg.ffmpeg.binaries','laravel-ffmpeg.ffmpeg.threads',
...
'laravel-ffmpeg.enable_logging','laravel-ffmpeg.set_command_and_error_output_on_exception','layout.layout','logging.default','logging.deprecations.channel',
...
'mail.markdown.paths','process.binaries.ps','process.binaries.kill','queue.default','queue.connections.sync.driver',
...
'queue.connections.deferred.driver','queue.connections.failover.driver','queue.connections.failover.connections','queue.connections.ffmpeg.driver','queue.connections.ffmpeg.table',
'queue.connections.ffmpeg.queue','queue.connections.ffmpeg.retry_after','queue.connections.ffmpeg.after_commit','queue.connections.player.driver','queue.connections.player.table',
'queue.connections.player.queue','queue.connections.player.retry_after','queue.connections.player.after_commit','queue.batching.database','queue.batching.table',
...
'transcode.vaapiDevice','transcode.videoCodecs','transcode.audioCodecs','transcode.subtitleCodecs','transcode.preferredLanguages',
'transcode.preferredAudioCodecs','view.paths','view.compiled','flare.key','flare.flare_middleware',
...
'home','layout.app','layout.html-head','partials.streamInfo','laravel-exceptions::401',
...
'APP_NAME','APP_ENV','APP_KEY','APP_URL','APP_PORT',
'APP_SERVICE','APP_LAYOUT','LOG_LEVEL','WWWUSER','WWWGROUP',
'SAIL_XDEBUG_MODE','FFMPEG_BINARIES','FFPROBE_BINARIES','VIDEO_CODECS','MEDIA_PATH_HOST',
'MEDIA_PATH_CONTAINER','PREFERRED_LANGUAGES','PREFERRED_AUDIO_CODECS',);
